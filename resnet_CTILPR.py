...
class ResNet(nn.Module):
    def __init__(self, num_nodes, enc_dim, resnet_type='18', nclasses=2):
        ...
        self.conv1 = nn.Conv2d(1, 16, kernel_size=(9, 3), stride=(6, 2), padding=(1, 1), bias=False)
        ...
        self.conv5 = nn.Conv2d(512 * block.expansion, 256, kernel_size=(num_nodes, 3), stride=(6, 2), padding=(0, 1),
                               bias=False)
