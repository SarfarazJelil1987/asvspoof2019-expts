...
def test_model(feat_model_path, loss_model_path, part, add_loss, device):
    ...
    test_set = ASVspoof2019("PA", "/media/sarfaraz/CQT_frame_rate_1/PA/pkl_features/",
                            "/home/phd/sarfaraz/ASVSpoof_2019/data/PA/ASVspoof2019_PA_cm_protocols/", part,
                            "LFCC", feat_len=256, padding="repeat")
    testDataLoader = DataLoader(test_set, batch_size=16, shuffle=False, num_workers=4,
    ...
    #eer_cm, min_tDCF = compute_eer_and_tdcf(os.path.join(dir_path, 'checkpoint_cm_score.txt'),"/home/phd/sarfaraz/ASVSpoof_2019/data/")
    #return eer_cm, min_tDCF

def test(score_file):

    eer_cm, min_tDCF = compute_eer_and_tdcf(score_file,"/home/phd/sarfaraz/data/")
...
if __name__ == "__main__":
    ...
    parser.add_argument('-s', '--score_file', type=str, help="path to score file", default="./model/softmax/score.txt")
    #parser.add_argument("--gpu", type=str, help="GPU index", default="0")
    args = parser.parse_args()
    os.environ["CUDA_VISIBLE_DEVICES"] = args.gpu
    args.device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    test(args.score_file)
