...
class ASVspoof2019(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        try:
            with open(self.ptf + '/'+ filename + '_' + self.feature + '.pkl', 'rb') as feature_handle:
...
if __name__ == "__main__":
    ...
    path_to_features = '/home/sarfaraz/sarfaraz/PhD_experiments/ASVSpoof_2019/AIR-ASVspoof/LA/pkl_features/'  # if run on GPU
    path_to_protocol = '/home/sarfaraz/sarfaraz/PhD_experiments/ASVSpoof_2019/data/LA/ASVspoof2019_LA_cm_protocols/'
